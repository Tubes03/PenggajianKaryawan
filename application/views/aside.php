<aside class="left-side sidebar-offcanvas">                
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="pekerjaan">
                                <i class="fa fa-archive"></i> <span>Data Pekerjaan</span>
                            </a>
                        </li>
                        <li>
                            <a href="gaji">
                                <i class="fa fa-archive"></i> <span>Gaji Karyawan</span>
                            </a>
                        </li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="app/lap_karyawan" target="_blank"><i class="fa fa-angle-double-right"></i> Laporan Data Karyawan</a></li>
                                <li><a href="app/lap_gajikaryawan" target="_blank"><i class="fa fa-angle-double-right"></i> Laporan Gaji Karyawan</a></li>
